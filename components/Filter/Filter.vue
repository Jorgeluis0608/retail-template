<template>
  <aside class="filter">
    ...
    <div class="filter-block">
      ...
      <v-text-field class="input-price" hide-details outlined v-model="from" placeholder="$ From" />
      &nbsp; - &nbsp;
      <v-text-field class="input-price" hide-details outlined v-model="to" placeholder="$ To" />
      <v-btn
        color="primary"
        :elevation="0"
        small
